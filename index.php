...
<body>
      ...
      <div class="hero">
         <div class="content">
            <h1 class="header">
               ...
               <br />sent through the website
            </h1>
            <br>
            <p class="primary-font">
               Express your untold <span class="typing"></span><br />in this
               website :D
            </p>
         </div>

         <div class="submit header" style="font-weight: 400;">
            <a href="submit.php">Tell your Confess!</a>
         </div>
      </div>
   </section>
   <!-- HERO SECT END -->
   ...
   <section class="container">
      <div class="box">
         ...
         <div class="submit header" style="font-weight: 400;">
            <a href="submit.php">Create Messages</a>
         </div>
      </div>
   ...
   <section class="confess">
      <div class="scroller">
         ...
         <!-- BOX BAWAH -->
         <?php
         $query = "SELECT * FROM confessbox2";
         $result = mysqli_query($conn, $query);
         ?>

         <div class="scroller-track2">
            <?php foreach ($result as $row) { ?>
               <div class="confess-box primary-font">
                  <h5>To &nbsp;: <?= $row['penerima'] ?> </h5>
                  <p> <?= $row['pesan'] ?> </p>
